...
const GitHubGlobe = () => {
  ...
  return (
    <div className='flex flex-row items-center justify-center h-full dark:bg-transparent bg-white relative w-ful'>
      <div className='mx-auto w-[800px] relative h-[800px] px-4'>
        <motion.div
          initial={{
            opacity: 0
          }}
        ...
        >
          <h2 className='text-center text-7xl md:text-6xl font-bold text-black dark:text-white whitespace-pre-line'>
            Пишите код вместе {`\n`} с{' '}
            <span className='text-[#5e6ad2]'>Connecticum</span>
          </h2>
        </motion.div>
        ...
        <div className='absolute w-full -bottom-11 md:h-full z-10'>
