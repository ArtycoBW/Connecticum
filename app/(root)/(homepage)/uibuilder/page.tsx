  ...
  return (
    <div className='flex flex-col w-full h-full'>
      <MaxWidthWrapper>
        ...
        >
          <h1 className='md:text-7xl text-3xl lg:text-8xl font-bold text-center text-white relative whitespace-pre-line z-20'>
            Создавайте что угодно {`\n`} вместе с{' '}
            <span style={{ color: '#5e6ad2' }}>UIBuilder</span>
          </h1>
        ...
        <MaxWidthWrapper>
          ...
          >
            <div className='flex-1 w-44 justify-center my-auto items-center space-y-3'>
              <h2 className='md:text-6xl text-3xl lg:text-5xl font-bold relative  whitespace-pre-line z-20 text-[#5e6ad2]'>
                Улучшайте {`\n`} командную работу
              </h2>
              ...
              >
                <p className='mr-2'>Sign up for free </p>
            ...
            <div className='flex w-1/2 flex-wrap justify-center items-center gap-y-4'>
              {items.map(item => (
                <div key={item.title} className='w-1/2 h-1/2'>
                  <div className='text-[#5e6ad2] pb-3'>{item.icon}</div>
