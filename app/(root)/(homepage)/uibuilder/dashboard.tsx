...
const Dashboard = () => {
  ...
  return (
    <div className=' flex flex-col justify-center items-center rounded-t-3xl -mt-10 h-[450px] overflow-hidden bg-gray-200 hover:bg-gray-300 pt-6'>
      <div className='flex justify-between items-center gap-96 px-10 pt-4'>
        ...
        <div className='flex gap-6'>
          ...
          <div className='flex justify-center items-center'>
            ...
            <div className='bg-white rounded-xl px-3 py-1 ml-4 flex justify-center items-center gap-1 hover:scale-125 transition-all cursor-pointer'>
